...
# Generate the grid query points using numpy's meshgrid function.
    grid_query_pts=torch.load('/home/ubuntu/Khan/semantic_nerf/tensor.pt')
    ...
    mesh_canonical=mesh_canonical.apply_translation([-0.5, -0.5, -0.5])
    mesh_canonical=mesh_canonical.apply_scale(2)
